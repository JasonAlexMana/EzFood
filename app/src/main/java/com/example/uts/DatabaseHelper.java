...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        insertProduk(db, "Biscuits", "Snack", 123, 1000);
        insertProduk(db, "Chocolates Chocolates", "Snack", 123, 1000);
        insertProduk(db, "Icecream", "Snack", 123, 1000);
        insertProduk(db, "Fruits ", "Snack", 123, 1000);
        insertProduk(db, "Pizza", "Food", 123, 1000);
        insertProduk(db, "Burger", "Food", 123, 1000);
        insertProduk(db, "Hotdog", "Food", 123, 1000);
        insertProduk(db, "Pasta", "Food", 123, 1000);
    }
    @Override
